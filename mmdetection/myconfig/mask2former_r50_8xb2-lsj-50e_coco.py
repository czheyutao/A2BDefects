...
interval = 5000
launcher = 'pytorch'
load_from = "/data/hyt/mmdetection/mask2former/mask2former_r50_8xb2-lsj-50e_coco_20220506_191028-41b088b6.pth"
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(img='test/', seg='annotations/panoptic_val/'),
        data_root='WZ/',
        pipeline=[
...
test_evaluator = dict(
    ...
    outfile_prefix='./mask2former/coco_instance/test',
    type='CocoMetric')
test_pipeline = [
    dict(backend_args=None, to_float32=True, type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
